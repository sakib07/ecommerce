...
<?php
 foreach ($all_published_product as $v_publishrd_product){?>
    <div class="col-sm-4">
        <div class="product-image-wrapper">
            <div class="single-products">
                    <div class="productinfo text-center">
                        <img src="{{URL::to($v_publishrd_product->product_image)}}" style="height: 210px;" alt="" />
                        <h2>{{$v_publishrd_product->product_price}} Tk</h2>
                        <p>{{$v_publishrd_product->product_name}}</p>
